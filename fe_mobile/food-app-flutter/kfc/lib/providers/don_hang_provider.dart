...
class DonHangProvider with ChangeNotifier {
  // Đã thay đổi để dùng static methods
  ...
  Future<String?> createDonHang({
    ...
    try {
      ...
      final id = await DonHangService.createDonHang(donHang);
  ...
  Future<void> fetchDonHangByUser(String userId) async {
    ...
    try {
      final orders = await DonHangService.getDonHangByUser(userId);
  ...
  Future<void> fetchDonHangById(String id) async {
    ...
    try {
      final order = await DonHangService.getDonHangById(id);
  ...
  Future<bool> updateTrangThaiDonHang(String id, TrangThaiDonHang trangThai) async {
    ...
    try {
      await DonHangService.updateTrangThaiDonHang(id, trangThai);
  ...
  Future<void> fetchAllDonHang() async {
    ...
    try {
      final orders = await DonHangService.getAllDonHang();
  ...
  Future<void> fetchDonHangByTrangThai(TrangThaiDonHang trangThai) async {
    ...
    try {
      // getDonHangByTrangThai chưa có trong service mới, tạm lấy tất cả rồi filter
      final allOrders = await DonHangService.getAllDonHang();
      final orders = allOrders.where((o) => o.trangThai == trangThai).toList();
  ...
  Future<void> fetchDonHangByUserAndTrangThai(String userId, TrangThaiDonHang trangThai) async {
    ...
    try {
      final allUserOrders = await DonHangService.getDonHangByUser(userId);
