...
class NguoiDungProvider with ChangeNotifier {
  ...
  // Cập nhật toàn bộ thông tin người dùng (cho màn hình chỉnh sửa)
  Future<void> capNhatThongTin(NguoiDung updatedUser) async {
    // TODO: Gọi API để update thông tin trên server
    // Ví dụ: await UserService.updateUserInfo(updatedUser);
