...
class DonHang {
  ...
  factory DonHang.fromJson(Map<String, dynamic> json) {
    return DonHang(
      id: (json['_id'] ?? json['id'])?.toString() ?? '', // Try _id first (MongoDB), then id
  ...
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{
      ...
      'thoiGianDat': thoiGianDat.toUtc().toIso8601String(), // Thêm UTC để có 'Z' cuối
      'ghiChu': ghiChu,
      'phuongThucThanhToan': phuongThucThanhToan,
    };
    // Chỉ gửi 'id' nếu có giá trị (tránh lưu _id="" ở MongoDB)
    if (id.isNotEmpty) {
      map['id'] = id;
    }
    return map;
